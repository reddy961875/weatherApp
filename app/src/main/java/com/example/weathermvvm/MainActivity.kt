...
import com.example.weathermvvm.Utilities.ApiUtilities
        ...
        binding.apply {
            ...
            when (id) {
                ...
                in 200..232 -> {
                    ...
                    weatherImg.setImageResource(R.drawable.ic_strom_weather)

                    mainLayout.background=ContextCompat
                        .getDrawable(this@MainActivity, R.drawable.thunder_strom_bg)
                ...
                in 600..622 -> {
                    ...
                    weatherImg.setImageResource(R.drawable.ic_snow_weatherpng)
                ...
                in 701..781 -> {
                    ...
                    weatherImg.setImageResource(R.drawable.ic_broken_cloud)

                    mainLayout.background=ContextCompat
                        .getDrawable(this@MainActivity, R.drawable.atmospher_bg)
